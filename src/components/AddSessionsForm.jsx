...
const AddSessionsForm = ({ userId }) => {
  ...
  // Calculate the date range: allow only dates in current month up to today
  const today = new Date()
  const firstDayOfMonth = new Date(today.getFullYear(), today.getMonth(), 1)

  // Format dates to YYYY-MM-DD using local time (avoid UTC date shift)
  ...
  const timeSlots = [
    ...
    { label: '8:30 AM - 9:45 AM', start: '08:30', end: '09:45' },
    { label: '10:00 AM - 11:00 AM', start: '10:00', end: '11:00' },
    { label: '5:40 PM - 6:40 PM', start: '17:40', end: '18:40' },
